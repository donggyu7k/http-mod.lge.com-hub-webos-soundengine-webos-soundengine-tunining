...
\item Frequency Response Check
	...
	% \item 100Hz에서 ref 신호와의 레벨 차이값이 10.0±1dBr 이내
	% \item 1kHz에서 ref 신호와의 레벨 차이값이 6.5±1dBr 이내
	% \item 5kHz에서 ref 신호와의 레벨 차이값이 9.0±1dBr 이내
	% \item 10kHz에서 ref 신호와의 레벨 차이값이 11.0±1dBr 이내
	\item 20Hz에서 ref 신호와의 레벨 차이값이 -10.0dBr 이하
