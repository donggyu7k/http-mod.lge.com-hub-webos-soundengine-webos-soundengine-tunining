...
\begin{itemize}
\begin{scriptsize}
\item 2015.02.27\_Ver.16 LF59 (webOS Lite) 스펙 추가, EF98 스펙 추가 (UF95와 동일)
\item 2015.03.02\_Ver.17 LF59 (webOS Lite) Cinema Home 스펙 수정, EF98 스펙 수정 (UF85와 동일)
\item 2015.03.09\_Ver.18 UF94 모델 추가
\item 2015.04.01\_Ver.19 LF59 Clearvoice, Sports 스펙 변경 / UF64 모델 추가 / UF86, UF77 스펙 변경
