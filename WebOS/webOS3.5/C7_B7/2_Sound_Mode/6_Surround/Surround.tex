...
\begin{itemize}\vspace{-3mm}
	...
	\begin{itemize}
		\item 50Hz에서 ref 신호와의 레벨 차이값이 1.7±2dBr 이내
		\item 1kHz에서 ref 신호와의 레벨 차이값이 -1.2±2dBr 이내
		\item 10kHz에서 ref 신호와의 레벨 차이값이 0.5±2dBr 이내
	\end{itemize}
	\item Antiphase Level Check
	\begin{itemize}
		\item 50Hz에서 ref 신호와의 레벨 차이값이 12.4±2dBr 이내
		\item 1kHz에서 ref 신호와의 레벨 차이값이 11.5±2dBr 이내
		\item 5kHz에서 ref 신호와의 레벨 차이값이 9.4±2dBr 이내
	\end{itemize}
\end{itemize}
} \\
