...
\title[WebOS 3.5v1 QA spec \alert{LGE CONFIDENTIAL}] % (optional, use only with long paper titles)
{LGSE QA Test Manual Ver.9}

\subtitle
{for M16P/K3LP/M2R - WebOS 3.5v1} % (optional)


\author[editor-Kichul Kim] % (optional, use only with lots of authors)
