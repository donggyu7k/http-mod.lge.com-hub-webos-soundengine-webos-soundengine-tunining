...
\title[WebOS 3.5 MR Minor QA spec \alert{LGE CONFIDENTIAL}] % (optional, use only with long paper titles)
{LGSE QA Test Manual Ver.11}

\subtitle
{for M16P/K3LP/M2R - WebOS 3.5 MR Minor} % (optional)


\author[editor-Kichul Kim, Sunha Jeon] % (optional, use only with lots of authors)
{Release : Sunha Jeon(sunha.jeon@lge.com)}
%Editor : Kichul Kim (kichul.kim@lge.com)
...
\begin{itemize}
\begin{scriptsize}
\item 2017.08.21\_Ver.11 ATMOS on/off  스펙 추가 (LGSE6.2 ATMOS OFF)

\item 2017.04.21\_Ver.10 W7 / C7, B7, 55E7 / G7, E7 (77, 65) / 86SJ95,75SJ95,SJ85,UJ98 / UHD/ SmartSound Store,SoundMode (Cinema)  스펙변경

\item 2017.03.07\_Ver.9 W7 / C7, B7, 55E7 / G7, E7 (77, 65) / 86SJ95,75SJ95,SJ85,UJ98 / UHD/ SmartSound,SoundMode (Cinema, Clear Voice, Sports, Music, Game, Surround)  스펙변경
...
\end{itemize}
\end{frame}
\subimport{../55_C7_B7/}{C7_B7.tex}	%done
...
\end{itemize}
\end{frame}
\subimport{../77_65_G7_E7/}{77_65_G7_E7.tex}			%done
...
\subimport{../86_75_SJ95_SJ85_UJ98/}{SJ95.tex}			%DONE
...
\subimport{../65_UHD_SJ95_85_80_UJ75_65_63/}{UHD.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subimport{../32_FHD/}{LJ61.tex}		%done
...
\subimport{../43_49_55_FHD_LJ61/}{LJ61.tex}			%done
